...
const CardData = [
  ...
  return (
    <div className='bg-white w-full mt-5 md:mb-6 '>
     
         <h1 className='text-[28px] text-center font-medium'>Key Features</h1>
         <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-24 w-fit mx-auto mt-12'>
       {
        CardData.map((elem, index)=>{
            return(
               <div
          key={index}
          className="bg-white h-[230px] text-black p-6 mt-9 rounded-xl shadow-[0px_2px_2px_black] hover:shadow-[0px_1px_10px_black] w-[270px] flex flex-col gap-3"
        >
