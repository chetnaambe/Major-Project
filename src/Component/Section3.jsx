...
const Section3 = () => {
  ...
  return (
    <div className='bg-[#F8FAFB] w-full mt-16  p-12'>
     
        <h1 className='text-[28px] text-center font-medium'>How it Works</h1>
    ...
    <div className="flex flex-col items-center lg:flex-row gap-18 lg:gap-12 justify-center mt-18">
      {works.map((work) => (
        <div
          key={work.id}
          className="hover:bg-white shadow-lg rounded-xl p-6 w-64 text-center hover:shadow-2xl transition-shadow h-[260px]"
